# Requirements Archive: v1.1 品牌升级 & 体验增强
...
- [x] **GROW-01**: 化妆师可以在作品详情页生成包含作品图片+个人信息的分享海报
- [x] **GROW-02**: 海报包含小程序码，扫码可直接进入作品详情
- [x] **GROW-03**: 化妆师可以将海报保存到手机相册
